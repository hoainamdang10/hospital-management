...
export interface IPermissionRepository {
     ...
     * console.log(roles); // ['doctor', 'nurse']
     * ```
     */
     ...
     *
     * @param userId - User ID
     * @param roleType - Role type to assign (e.g., 'doctor', 'nurse')
     ...
     * @example
     * ```typescript
     * await permissionRepository.removeRole(userId, 'nurse', adminUserId);
     * ```
     */
     ...
     * console.log(allRoles); // ['admin', 'doctor', 'nurse', 'patient', ...]
     * ```
     */
