/**
 * RBAC Unit Tests
 * Unit tests for Role-Based Access Control middleware and permission system with mocked dependencies
 *
 * NOTE: These are UNIT tests with mocks, not integration tests.
