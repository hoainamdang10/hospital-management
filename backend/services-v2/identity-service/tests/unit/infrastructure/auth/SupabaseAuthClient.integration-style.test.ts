...
/**
 * Authentication Unit Tests (Integration-Style)
 * Unit tests for authentication flow using an in-memory Supabase mock.
 *
 * NOTE: These are UNIT tests with mocks, not true integration tests.
 * For real integration tests with actual database, see tests/integration/
 */
...
describe('Authentication Unit Tests (Integration-Style)', () => {
