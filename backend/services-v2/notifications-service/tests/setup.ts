...
export const VIETNAMESE_HEALTHCARE_CONSTANTS = {
...
export const mockSocketIOServer = {
  on: jest.fn(),
  emit: jest.fn(),
...
export const generateVietnameseTestData = {
  patient: () => ({
    patientId: VIETNAMESE_HEALTHCARE_CONSTANTS.PATIENT_ID,
    fullName: VIETNAMESE_HEALTHCARE_CONSTANTS.PATIENT_NAME,
    phoneNumber: VIETNAMESE_HEALTHCARE_CONSTANTS.PHONE_NUMBER,
    email: VIETNAMESE_HEALTHCARE_CONSTANTS.EMAIL,
  ...
  doctor: () => ({
    ...
    fullName: VIETNAMESE_HEALTHCARE_CONSTANTS.DOCTOR_NAME,
  ...
  appointment: () => ({
    ...
    patientId: VIETNAMESE_HEALTHCARE_CONSTANTS.PATIENT_ID,
    doctorId: VIETNAMESE_HEALTHCARE_CONSTANTS.DOCTOR_ID,
    appointmentDate: VIETNAMESE_HEALTHCARE_CONSTANTS.APPOINTMENT_DATE,
    appointmentTime: VIETNAMESE_HEALTHCARE_CONSTANTS.APPOINTMENT_TIME,
    roomNumber: VIETNAMESE_HEALTHCARE_CONSTANTS.ROOM_NUMBER,
    status: 'SCHEDULED',
    notes: 'Khám định kỳ'
  }),
  
  notification: () => ({
    notificationId: VIETNAMESE_HEALTHCARE_CONSTANTS.NOTIFICATION_ID,
  ...
  integrationEvent: () => ({
    ...
    aggregateId: VIETNAMESE_HEALTHCARE_CONSTANTS.APPOINTMENT_ID,
