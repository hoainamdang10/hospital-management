...
export class NotificationEventHandlers {
  ...
  public async handleScheduleRunDue(event: ScheduleRunDueEvent): Promise<void> {
    ...
    try {
      ...
      try {
        const inboxEvent =
          await this.inboxRepo.findByIdempotencyKey(idempotencyKey);
        if (inboxEvent) {
        ...
        console.error(
          `[Inbox] Failed to update inbox event ${idempotencyKey}:`,
          updateError,
        );
      }

      throw new Error(
        `Lỗi xử lý sự kiện schedule run due: ${error instanceof Error ? error.message : "Lỗi không xác định"}`,
      );
    }
  }
   ...
   */
  public async handleAppointmentScheduled(
    ...
    try {
      ...
      throw new Error(
        `Lỗi xử lý sự kiện appointment scheduled: ${error instanceof Error ? error.message : "Lỗi không xác định"}`,
      );
    }
  }
   ...
   */
  public async handleAppointmentCancelled(
    event: IntegrationEvent,
  ): Promise<void> {
    try {
      const {
      ...
      throw new Error(
        `Lỗi xử lý sự kiện appointment cancelled: ${error instanceof Error ? error.message : "Lỗi không xác định"}`,
      );
    }
  }
   ...
   */
  public async handleMedicalRecordUpdated(
    event: IntegrationEvent,
  ): Promise<void> {
    try {
      const {
      ...
      throw new Error(
        `Lỗi xử lý sự kiện medical record updated: ${error instanceof Error ? error.message : "Lỗi không xác định"}`,
      );
    }
  }
  ...
  public async handleInvoiceGenerated(event: IntegrationEvent): Promise<void> {
    try {
      ...
      throw new Error(
        `Lỗi xử lý sự kiện invoice generated: ${error instanceof Error ? error.message : "Lỗi không xác định"}`,
      );
    }
  }
  ...
  public async handlePaymentCompleted(event: IntegrationEvent): Promise<void> {
    try {
      const { paymentId, invoiceId, patientId, amount, paymentMethod } =
        event.eventData;
      ...
      throw new Error(
        `Lỗi xử lý sự kiện payment completed: ${error instanceof Error ? error.message : "Lỗi không xác định"}`,
      );
    }
  }
    ...
    try {
      ...
      await this.notificationService.sendNotification({
        ...
        templateData: {
          ...
          actionRequired:
            event.eventData.actionRequired || "Liên hệ ngay với bệnh viện",
          emergencyPhone: "115",
          hospitalName: "Bệnh viện Đa khoa",
        },
      ...
      throw new Error(
        `Lỗi xử lý sự kiện emergency alert: ${error instanceof Error ? error.message : "Lỗi không xác định"}`,
      );
    }
  }
   ...
   */
  public async handleMedicationReminder(
    event: IntegrationEvent,
  ): Promise<void> {
    try {
      const {
      ...
      throw new Error(
        `Lỗi xử lý sự kiện medication reminder: ${error instanceof Error ? error.message : "Lỗi không xác định"}`,
      );
    }
  }
  ...
  public async handleUserCreated(event: IntegrationEvent): Promise<void> {
    try {
      ...
      throw new Error(
        `Lỗi xử lý sự kiện user created: ${error instanceof Error ? error.message : "Lỗi không xác định"}`,
      );
    }
  }
  ...
  public async handleUserActivated(event: IntegrationEvent): Promise<void> {
    try {
      ...
      throw new Error(
        `Lỗi xử lý sự kiện user activated: ${error instanceof Error ? error.message : "Lỗi không xác định"}`,
      );
    }
  }
  ...
  public async handlePasswordReset(event: IntegrationEvent): Promise<void> {
    try {
      const { userId, email, firstName, lastName, resetToken, resetUrl } =
        event.eventData;
      ...
      await this.notificationService.sendNotification({
        ...
        templateData: {
          ...
          hospitalName: "Bệnh viện Đa khoa",
          securityTip:
            "Nếu bạn không yêu cầu đặt lại mật khẩu, vui lòng bỏ qua email này và liên hệ với chúng tôi ngay.",
        },
        channels: ["EMAIL"],
        priority: "HIGH",
        metadata: {
      ...
      throw new Error(
        `Lỗi xử lý sự kiện password reset: ${error instanceof Error ? error.message : "Lỗi không xác định"}`,
      );
    }
  }
  ...
  public async handleUserRoleChanged(event: IntegrationEvent): Promise<void> {
    try {
      const { userId, email, firstName, lastName, oldRole, newRole } =
        event.eventData;
      ...
      throw new Error(
        `Lỗi xử lý sự kiện user role changed: ${error instanceof Error ? error.message : "Lỗi không xác định"}`,
      );
    }
  }
   ...
   */
  public async handleStaffInvitationCreated(
    event: IntegrationEvent,
  ): Promise<void> {
    try {
      const {
      ...
      throw new Error(
        `Lỗi xử lý sự kiện staff invitation created: ${error instanceof Error ? error.message : "Lỗi không xác định"}`,
      );
    }
  }
  ...
  public async handlePatientRegistered(event: IntegrationEvent): Promise<void> {
    try {
      ...
      throw new Error(
        `Lỗi xử lý sự kiện patient registered: ${error instanceof Error ? error.message : "Lỗi không xác định"}`,
      );
    }
  }
  ...
  public async handlePatientUpdated(event: IntegrationEvent): Promise<void> {
    try {
      ...
      throw new Error(
        `Lỗi xử lý sự kiện patient updated: ${error instanceof Error ? error.message : "Lỗi không xác định"}`,
      );
    }
  }
   ...
   */
  public async handlePatientDeactivated(
    event: IntegrationEvent,
  ): Promise<void> {
    try {
      ...
      throw new Error(
        `Lỗi xử lý sự kiện patient deactivated: ${error instanceof Error ? error.message : "Lỗi không xác định"}`,
      );
    }
  }
   ...
   */
  public async handlePatientConsentGranted(
    event: IntegrationEvent,
  ): Promise<void> {
    try {
      const { patientId, personalInfo, consentType, consentDetails } =
        event.eventData;
      const { firstName, lastName } = personalInfo || {};
      ...
      throw new Error(
        `Lỗi xử lý sự kiện patient consent granted: ${error instanceof Error ? error.message : "Lỗi không xác định"}`,
      );
    }
  }
  ...
  public async handleEvent(
    event: IntegrationEvent | ScheduleRunDueEvent,
  ): Promise<void> {
    try {
      const eventType = "eventType" in event ? event.eventType : event.type;
      const serviceName =
        "serviceName" in event ? event.serviceName : "SCHEDULER_SERVICE";
      ...
      switch (integrationEvent.eventType) {
        ...
        default:
          console.warn(
            `Không có handler cho sự kiện: ${integrationEvent.eventType}`,
          );
          break;
      }
    } catch (error) {
