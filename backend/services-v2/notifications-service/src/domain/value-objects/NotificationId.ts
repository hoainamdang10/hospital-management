...
export class NotificationId {
   ...
   */
  public getYearMonth(): { year: number; month: number } {
   ...
   * Create from JSON
   */
  public static fromJSON(json: string): NotificationId {
   ...
   */
  public static generateNext(lastId: NotificationId): NotificationId {
   ...
   */
  public static createBatch(count: number): NotificationId[] {
   ...
   */
  public static tryParse(value: string): { success: boolean; notificationId?: NotificationId; error?: string } {
    try {
