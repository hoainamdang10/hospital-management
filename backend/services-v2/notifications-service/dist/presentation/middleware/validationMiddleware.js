...
exports.validateHealthcareFields = exports.validationMiddleware = void 0;
...
function validateFormat(value, format, fieldPath) {
    switch (format) {
        case 'email':
 ...
 */
const validateHealthcareFields = (req, res, next) => {
    try {
        const errors = [];
...
exports.validateHealthcareFields = validateHealthcareFields;
