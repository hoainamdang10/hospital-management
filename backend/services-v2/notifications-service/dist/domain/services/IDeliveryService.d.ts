...
export interface IDeliveryService {
     ...
     */
    retryDelivery(notificationId: string, failedChannels: string[], maxRetries?: number): Promise<DeliveryResult[]>;
    /**
     * Get delivery status
     */
     ...
     */
    canDeliverToRecipient(recipient: RecipientInfo, channels: NotificationChannel[], currentTime?: Date): Promise<{
        canDeliver: boolean;
     ...
     */
    getOptimalChannels(recipient: RecipientInfo, priority: 'LOW' | 'NORMAL' | 'HIGH' | 'URGENT', contentType?: string): Promise<NotificationChannel[]>;
    /**
     ...
     */
    setChannelRateLimit(channel: string, maxRequests: number, windowMs: number): Promise<void>;
    /**
     ...
     */
    estimateDeliveryCost(channels: string[], recipientCount: number, contentLength?: number): Promise<{
        totalCost: number;
        costByChannel: Record<string, number>;
        currency: string;
    }>;
     ...
     */
    getDeliveryAnalytics(dateRange: {
        start: Date;
        end: Date;
    }): Promise<{
     ...
     */
    configureChannelProvider(channel: string, providerConfig: Record<string, any>): Promise<void>;
    /**
     ...
     */
    switchChannelProvider(channel: string, newProvider: string, config: Record<string, any>): Promise<void>;
    /**
     ...
     */
    exportDeliveryData(dateRange: {
        start: Date;
        end: Date;
    }, format: 'JSON' | 'CSV' | 'EXCEL'): Promise<string>;
    /**
...
//# sourceMappingURL=IDeliveryService.d.ts.map