 ...
 */
export type TemplateType = 'APPOINTMENT_REMINDER' | 'APPOINTMENT_CONFIRMATION' | 'APPOINTMENT_CANCELLATION' | 'TEST_RESULT_READY' | 'MEDICATION_REMINDER' | 'BILLING_INVOICE' | 'PAYMENT_CONFIRMATION' | 'EMERGENCY_ALERT' | 'SYSTEM_MAINTENANCE' | 'WELCOME_MESSAGE' | 'PASSWORD_RESET' | 'ACCOUNT_VERIFICATION';
