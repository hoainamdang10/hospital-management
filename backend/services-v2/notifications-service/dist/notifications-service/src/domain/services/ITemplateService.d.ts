...
export interface ITemplateService {
     ...
     */
    getTemplateUsageStatistics(templateId?: string, dateRange?: {
        start: Date;
        end: Date;
     ...
     */
    getTemplatePerformanceMetrics(templateId: string, dateRange?: {
        start: Date;
        end: Date;
     ...
     */
    getMostUsedTemplates(limit?: number, dateRange?: {
        start: Date;
        end: Date;
    }): Promise<TemplateUsageStatistics[]>;
    /**
     ...
     */
    getBestPerformingTemplates(limit?: number, dateRange?: {
        start: Date;
        end: Date;
    }): Promise<TemplatePerformanceMetrics[]>;
    /**
     ...
     */
    cloneTemplate(sourceTemplateId: string, newTemplateId: string, modifications?: Partial<{
        name: string;
        description: string;
        content: any;
        language: 'vi' | 'en';
     ...
     */
    createTemplateVersion(templateId: string, changes: Partial<NotificationTemplate>, versionNotes?: string): Promise<NotificationTemplate>;
    /**
     ...
     */
    testTemplate(templateId: string, testData: Record<string, any>, channels: string[]): Promise<{
        success: boolean;
        results: Array<{
            channel: string;
     ...
     */
    getTemplateRecommendations(recipientType: string, context?: {
        templateType?: TemplateType;
        language?: 'vi' | 'en';
        priority?: TemplatePriority;
        channels?: string[];
     ...
     */
    optimizeTemplateForChannel(templateId: string, channelType: string): Promise<NotificationTemplate>;
    /**
     ...
     */
    generateTemplateFromSample(sampleContent: string, templateType: TemplateType, language: 'vi' | 'en'): Promise<NotificationTemplate>;
    /**
     ...
     */
    getTemplateAnalytics(templateId: string, dateRange?: {
        start: Date;
        end: Date;
    }): Promise<{
        totalUsage: number;
     ...
     */
    bulkUpdateTemplates(templateIds: string[], updates: Partial<{
        isActive: boolean;
        priority: TemplatePriority;
        tags: string[];
    }>): Promise<void>;
     ...
     */
    searchTemplatesByContent(searchQuery: string, language?: 'vi' | 'en', limit?: number): Promise<NotificationTemplate[]>;
    /**
...
//# sourceMappingURL=ITemplateService.d.ts.map