...
exports.ipRateLimitMiddleware = exports.healthcareRateLimitMiddleware = exports.rateLimitMiddleware = void 0;
class RateLimiter {
    constructor(config) {
        this.store = {};
        this.config = config;
 ...
 */
const healthcareRateLimitMiddleware = (req, res, next) => {
    try {
...
exports.healthcareRateLimitMiddleware = healthcareRateLimitMiddleware;
function getHealthcareLimiter(userRole) {
    switch (userRole) {
        case 'DOCTOR':
...
function getHealthcareRateLimitMessage(userRole) {
    const roleMessages = {
 ...
 */
const ipRateLimitMiddleware = (req, res, next) => {
    try {
        const ip = req.ip || req.connection.remoteAddress || 'unknown';
...
exports.ipRateLimitMiddleware = ipRateLimitMiddleware;
