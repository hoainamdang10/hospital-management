...
import { AppointmentBillingWorkflow } from "../workflows/AppointmentBillingWorkflow";
import { NotificationTriggerWorkflow } from "../workflows/NotificationTriggerWorkflow";
import { PatientJourneyWorkflow } from "../workflows/PatientJourneyWorkflow";
import {
...
export class EndToEndTestSuite {
  private static instance: EndToEndTestSuite;
  private integrationFramework: IntegrationTestFramework;
  private patientJourneyWorkflow: PatientJourneyWorkflow;
  private appointmentBillingWorkflow: AppointmentBillingWorkflow;
  private notificationTriggerWorkflow: NotificationTriggerWorkflow;
  private e2eResults: Map<string, E2EResult> = new Map();

  private constructor() {
    this.integrationFramework = IntegrationTestFramework.getInstance();
    this.patientJourneyWorkflow = PatientJourneyWorkflow.getInstance();
    this.appointmentBillingWorkflow = AppointmentBillingWorkflow.getInstance();
    this.notificationTriggerWorkflow =
      NotificationTriggerWorkflow.getInstance();
  }

  public static getInstance(): EndToEndTestSuite {
  ...
  public async runEndToEndTests(): Promise<TestSuite> {
    ...
    try {
      ...
      const testSuite: TestSuite = {
        ...
        vietnameseSuiteName:
          "Kiểm thử End-to-End Hệ thống Quản lý Bệnh viện V2",
        description: "Complete patient journey end-to-end testing",
        vietnameseDescription:
          "Kiểm thử end-to-end hành trình bệnh nhân hoàn chỉnh",
        tests: testResults,
        totalTests,
        passedTests,
        failedTests,
   ...
   * Define E2E scenarios
   */
  private defineE2EScenarios(): E2EScenario[] {
    return [
   ...
   */
  private defineCompletePatientJourneyScenario(): E2EScenario {
    return {
      ...
      vietnameseDescription:
        "Hành trình bệnh nhân end-to-end từ đăng ký đến xuất viện",
   ...
   */
  private defineEmergencyPatientScenario(): E2EScenario {
    return {
   ...
   */
  private defineInsurancePatientScenario(): E2EScenario {
    return {
   ...
   */
  private defineFollowUpPatientScenario(): E2EScenario {
    return {
      ...
      vietnameseDescription:
        "Quy trình tái khám bệnh nhân với theo dõi tiến triển",
   ...
   */
  private defineMultipleAppointmentsScenario(): E2EScenario {
    return {
      ...
      description:
        "Patient with multiple appointments across different departments",
   ...
   */
  private defineBillingWorkflowScenario(): E2EScenario {
    return {
      ...
      vietnameseDescription:
        "Quy trình thanh toán end-to-end với tích hợp PayOS",
   ...
   */
  private defineNotificationWorkflowScenario(): E2EScenario {
    return {
   ...
   */
  private defineVietnameseHealthcareScenario(): E2EScenario {
    return {
      ...
      description:
        "Complete workflow with Vietnamese healthcare standards compliance",
      vietnameseDescription:
        "Quy trình hoàn chỉnh tuân thủ tiêu chuẩn y tế Việt Nam",
  ...
  private async executeE2EScenario(scenario: E2EScenario): Promise<E2EResult> {
    ...
    try {
      ...
      const healthcareMetrics = this.calculateHealthcareMetrics(
        scenario,
        stepResults
      );
      ...
      console.log(
        `  💥 Scenario error: ${scenario.scenarioName} (${executionTime}ms)`
      );
   ...
   */
  private async executeE2EStep(step: E2EStep, context: any): Promise<any> {
    ...
    switch (step.action) {
      case "register_patient":
        return {
          ...
          vietnameseNamePreserved:
            step.input.fullName.includes("ệ") ||
      ...
      case "generate_invoice":
        const totalAmount = step.input.services.reduce(
        ...
        return {
          ...
          totalAmount,
          vietnameseServices: step.input.services.some((s: any) =>
            s.serviceName.includes("Khám")
          ),
        };
      ...
      case "send_multi_channel_notification":
        return {
          ...
          vietnameseContentPreserved:
            step.input.vietnameseContent.subject.includes("ệ"),
        };
   ...
   */
  private calculateE2EEndpointCoverage(results: E2EResult[]): number {
   ...
   */
  private calculateE2EWorkflowCoverage(results: E2EResult[]): number {
   ...
   */
  public getE2ETestSuiteStatus(): any {
    return {
