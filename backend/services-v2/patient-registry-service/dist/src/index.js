"use strict";
/**
 * Patient Registry Service - Hospital Management System
...
app.listen(PORT, () => {
    ...
    logger_1.logger.info(`📋 Features: ${config.features.join(', ')}`);
    logger_1.logger.info(`🎯 Patterns: ${config.patterns.join(', ')}`);
});
exports.default = app;
