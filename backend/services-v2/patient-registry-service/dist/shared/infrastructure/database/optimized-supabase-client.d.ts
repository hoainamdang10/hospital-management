...
export declare class OptimizedSupabaseClient {
     ...
     */
    from(table: string): import("node_modules/@supabase/postgrest-js/dist/cjs").PostgrestQueryBuilder<any, any, any, string, unknown>;
    /**
     * Proxy method for RPC calls
     */
    rpc(fn: string, params?: any): import("node_modules/@supabase/postgrest-js/dist/cjs").PostgrestFilterBuilder<any, any, any, any, string, null, "RPC">;
    /**
     * Proxy method for storage access
     */
    get storage(): import("node_modules/@supabase/storage-js/dist/module").StorageClient;
    /**
     * Proxy method for auth access
     */
    get auth(): import("node_modules/@supabase/supabase-js/dist/module/lib/SupabaseAuthClient").SupabaseAuthClient;
    /**
