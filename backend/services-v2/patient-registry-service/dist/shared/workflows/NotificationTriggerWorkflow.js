...
exports.NotificationTriggerWorkflow = void 0;
...
class NotificationTriggerWorkflow {
     ...
     */
    registerAppointmentNotificationWorkflow() {
        const workflow = {
     ...
     */
    registerMedicationReminderWorkflow() {
        const workflow = {
     ...
     */
    registerEmergencyNotificationWorkflow() {
        const workflow = {
     ...
     */
    registerBillingNotificationWorkflow() {
        const workflow = {
     ...
     */
    registerSystemNotificationWorkflow() {
        const workflow = {
     ...
     */
    registerFollowUpReminderWorkflow() {
        const workflow = {
     ...
     */
    registerInsuranceNotificationWorkflow() {
        const workflow = {
     ...
     */
    registerMultiChannelNotificationWorkflow() {
        const workflow = {
...
exports.NotificationTriggerWorkflow = NotificationTriggerWorkflow;
//# sourceMappingURL=NotificationTriggerWorkflow.js.map