...
class PatientRegistryServiceApp {
    ...
    async initializeDependencies() {
        ...
        try {
            ...
            this.supabaseClient =
                this.optimizedSupabase.getConnection();
            ...
            this.deactivatePatientUseCase,
            END POST-MVP */
            this.validateInsuranceUseCase, this.getInsuranceInfoUseCase, this.addInsuranceInfoUseCase, this.updateInsuranceInfoUseCase, this.verifyInsuranceUseCase, this.addEmergencyContactUseCase, this.getEmergencyContactsUseCase, this.updateEmergencyContactUseCase, this.getPatientStatisticsUseCase);
            ...
            const userDeactivatedHandler = new infrastructure_1.UserDeactivatedEventHandler(logger, this.patientRepository);
            ...
            this.identityEventConsumer = new infrastructure_1.IdentityEventConsumer({
                ...
                connectionRetries: rabbitmqConnectionRetries,
                connectionRetryDelayMs: rabbitmqConnectionRetryDelayMs,
            }, logger, userCreatedHandler, userDeletedHandler, userUpdatedHandler, userActivatedHandler, userDeactivatedHandler, this.auditService);
