...
exports.SearchPatientsUseCase = void 0;
    ...
    async execute(request) {
        try {
            ...
            if (request.filters?.city) {
                filteredPatients = filteredPatients.filter(patient => patient.getContactInfo().address.city.toLowerCase().includes(request.filters.city.toLowerCase()));
            }
            if (request.filters?.province) {
                filteredPatients = filteredPatients.filter(patient => patient.getContactInfo().address.province.toLowerCase().includes(request.filters.province.toLowerCase()));
            }
            if (request.filters?.hasInsurance !== undefined) {
                filteredPatients = filteredPatients.filter(patient => request.filters.hasInsurance ? patient.hasValidInsurance() : !patient.hasValidInsurance());
            }
...
exports.SearchPatientsUseCase = SearchPatientsUseCase;
//# sourceMappingURL=SearchPatientsUseCase.js.map