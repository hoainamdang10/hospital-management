...
exports.UpdateEmergencyContactUseCase = void 0;
...
class UpdateEmergencyContactUseCase {
    ...
    async execute(command) {
        ...
        try {
            ...
            contact.updateContactInfo(command.name, command.primaryPhone, command.secondaryPhone, command.email, command.address);
...
exports.UpdateEmergencyContactUseCase = UpdateEmergencyContactUseCase;
//# sourceMappingURL=UpdateEmergencyContactUseCase.js.map