...
class InsuranceValidationService {
     ...
     */
    async validateBHYTNumber(bhytNumber) {
        const errors = [];
        const warnings = [];
        const metadata = {};
        try {
     ...
     */
    async validateBHTNNumber(bhtnNumber) {
        const errors = [];
        const warnings = [];
        const metadata = {};
        try {
     ...
     */
    checkExpiration(_validFrom, validTo) {
        const now = new Date();
     ...
     */
    async validateInsurance(insuranceType, policyNumber, validFrom, validTo) {
