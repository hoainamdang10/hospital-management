/**
 * UpdateEmergencyContactUseCase Tests
...
describe('UpdateEmergencyContactUseCase', () => {
  ...
  beforeEach(() => {
    ...
    useCase = new UpdateEmergencyContactUseCase(mockRepository, mockEventBus, mockLogger);
  });
  ...
  describe('execute', () => {
    it('should update emergency contact successfully', async () => {
      ...
      const command = {
        ...
        name: 'Nguyễn Thị B Updated',
        relationship: 'Vợ',
        primaryPhone: '0909888888',
      ...
      expect(result.contactId).toBe(contact.getId());
    ...
    it('should handle repository errors gracefully', async () => {
      ...
      expect(result.success).toBe(false);
      expect(result.message).toContain('Lỗi khi cập nhật người liên hệ khẩn cấp');
