...
export class SupabaseStorageService {
  private readonly bucketName = 'patient-photos';
   ...
   */
  async deletePatientPhoto(filePath: string): Promise<void> {
    try {
   ...
   */
  async deleteAllPatientPhotos(patientId: string): Promise<void> {
    try {
