...
describe('ProviderStaff Aggregate', () => {
  ...
  describe('create', () => {
    it('should create ProviderStaff with valid data', () => {
      ...
      const employmentType = 'full_time' as const;
      ...
      expect(staff.staffId).toBeInstanceOf(StaffId);
    ...
    it('should generate StaffRegistered domain event', () => {
      ...
      expect(events[0].getEventData()).toMatchObject({
  ...
  describe('updatePersonalInfo', () => {
    ...
    it('should generate StaffUpdated domain event', () => {
      ...
      staff.markEventsAsCommitted(); // Clear creation events
  ...
  describe('domain events', () => {
    ...
    it('should clear domain events', () => {
      ...
      // Assert
      expect(staff.getUncommittedEvents().length).toBe(0);
    });
  });
});
