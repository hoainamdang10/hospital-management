...
describe('VerifyStaffCredentialUseCase', () => {
  ...
  describe('execute', () => {
    it('should verify credential successfully', async () => {
      ...
      const mockCredential = StaffCredential.create({
        credentialNumber: 'VN-DOC-12345',
        credentialType: 'license',
        issuingAuthority: 'Bộ Y tế',
        issueDate: new Date('2020-01-01'),
        expiryDate: new Date('2030-01-01')
      });
      (mockCredential as any).id = credentialId;
      (mockCredential as any).props.isValid = false;
    ...
    it('should fail when credential already verified', async () => {
      ...
      (mockCredential as any).id = 'cred-456';
      // isValid is already true by default from create()
