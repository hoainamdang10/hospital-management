...
export class ProfessionalInfo extends HealthcareValueObject<ProfessionalInfoProps> {
  ...
  public speaksLanguage(language: string): boolean {
    return this.props.languages.some(l => 
  ...
  public isVietnameseCompliant(): boolean {
    ...
    return this.speaksLanguage('Vietnamese') || 
  ...
  public equals(other: ProfessionalInfo): boolean {
    ...
    return this.props.title === other.props.title &&
           ...
           JSON.stringify(this.props.education) === JSON.stringify(other.props.education) &&
           JSON.stringify(this.props.languages) === JSON.stringify(other.props.languages) &&
