 ...
 * Retrieves all staff members in a specific department
 */
export class GetStaffByDepartmentUseCase extends BaseHealthcareUseCase<
  GetStaffByDepartmentRequest,
  GetStaffByDepartmentResponse
> {
  constructor(
  ...
  protected async executeImpl(
    ...
    try {
      ...
      let staff = await this.staffRepository.findByDepartment(
