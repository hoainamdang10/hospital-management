...
class GetMedicalRecordUseCase extends use_case_interface_1.BaseHealthcareUseCase {
    ...
    async executeInternal(request) {
        try {
            ...
            // Map to DTO
            const medicalRecordDto = (0, GetMedicalRecordRequest_1.mapMedicalRecordToDto)(medicalRecord);
    ...
    async validate(request) {
        const errors = (0, GetMedicalRecordRequest_1.validateGetMedicalRecordRequest)(request);
        return {
...
//# sourceMappingURL=GetMedicalRecordUseCase.js.map