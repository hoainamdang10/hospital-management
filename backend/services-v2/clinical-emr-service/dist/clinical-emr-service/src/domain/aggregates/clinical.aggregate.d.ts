...
export declare class MedicalRecordAggregate extends HealthcareAggregateRoot<MedicalRecordProps> {
    ...
    get medicationsLegacy(): string | undefined;
    ...
    get fhirVersion(): string | undefined;
    get fhirProfile(): string | undefined;
    get vietnameseMedicalCode(): string | undefined;
    get specialtyCode(): string | undefined;
    get hospitalCode(): string | undefined;
