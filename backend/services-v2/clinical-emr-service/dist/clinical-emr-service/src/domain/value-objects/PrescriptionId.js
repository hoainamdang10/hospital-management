 ...
 */
class PrescriptionId extends value_object_1.ValueObject {
    constructor(props) {
        super(props);
    }
    /**
    ...
    static create(value) {
        ...
        if (!this.FORMAT_REGEX.test(trimmedValue)) {
            throw new Error(`PrescriptionId phải có định dạng PRESC-YYYYMM-XXX (e.g., PRESC-202501-001), nhận được: ${trimmedValue}`);
        }
    ...
    validateFormat() {
        if (!PrescriptionId.FORMAT_REGEX.test(this.props.value)) {
            throw new Error(`PrescriptionId không hợp lệ: ${this.props.value}. Định dạng yêu cầu: PRESC-YYYYMM-XXX`);
        }
...
exports.PrescriptionId = PrescriptionId;
PrescriptionId.FORMAT_REGEX = /^PRESC-\d{6}-\d{3}$/;
//# sourceMappingURL=PrescriptionId.js.map