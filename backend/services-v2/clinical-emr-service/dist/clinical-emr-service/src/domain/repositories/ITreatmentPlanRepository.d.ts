...
export interface ITreatmentPlanRepository {
     ...
     */
    findByPrimaryDoctor(doctorId: string, options?: {
        status?: TreatmentPlanStatus;
        limit?: number;
        offset?: number;
    }): Promise<TreatmentPlanAggregate[]>;
     ...
     */
    findByConsultingDoctor(doctorId: string, options?: {
        status?: TreatmentPlanStatus;
        limit?: number;
        offset?: number;
    }): Promise<TreatmentPlanAggregate[]>;
     ...
     */
    findByDiagnosis(diagnosisCode: string, options?: {
        limit?: number;
        offset?: number;
    }): Promise<TreatmentPlanAggregate[]>;
    /**
...
//# sourceMappingURL=ITreatmentPlanRepository.d.ts.map