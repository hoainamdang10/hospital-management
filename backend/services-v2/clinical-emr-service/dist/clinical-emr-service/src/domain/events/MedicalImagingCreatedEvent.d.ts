...
export declare class MedicalImagingCreatedEvent extends DomainEvent<MedicalImagingCreatedEventPayload> {
    constructor(payload: MedicalImagingCreatedEventPayload);
}
//# sourceMappingURL=MedicalImagingCreatedEvent.d.ts.map