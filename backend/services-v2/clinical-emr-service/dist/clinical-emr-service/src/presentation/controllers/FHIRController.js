...
class FHIRController extends BaseController_1.BaseController {
    constructor(bulkExportFHIRUseCase) {
        super();
        this.bulkExportFHIRUseCase = bulkExportFHIRUseCase;
    }
    /**
     * @swagger
