...
exports.createTreatmentPlanRoutes = createTreatmentPlanRoutes;
 ...
 */
function createTreatmentPlanRoutes(controller) {
     ...
     */
    router.post('/', authMiddleware.authenticate(), authMiddleware.requireDoctor(), // Only doctors can create treatment plans
     ...
     */
    router.get('/:planId', authMiddleware.authenticate(), authMiddleware.requireHealthcareStaff(), (req, res, next) => controller.getPlan(req, res, next));
    /**
     ...
     */
    router.put('/:planId', authMiddleware.authenticate(), authMiddleware.requireDoctorOrAdmin(), (req, res, next) => controller.updatePlan(req, res, next));
    /**
     ...
     */
    router.post('/:planId/complete', authMiddleware.authenticate(), authMiddleware.requireDoctorOrAdmin(), (req, res, next) => controller.completePlan(req, res, next));
    /**
     ...
     */
    router.get('/', authMiddleware.authenticate(), authMiddleware.requireHealthcareStaff(), (req, res, next) => controller.listPlans(req, res, next));
    // =====================================================
...
//# sourceMappingURL=treatmentPlanRoutes.js.map