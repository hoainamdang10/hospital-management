...
const DEFAULT_CONFIG = {
    ...
    retryIntervalMs: 5000, // Retry after 5 seconds
    cleanupIntervalMs: 3600000, // Cleanup every hour
    retentionDays: 30, // Keep 30 days
    enabled: true,
};
let OutboxPublisherWorker = class OutboxPublisherWorker {
    constructor(outboxRepository, eventBus, supabase, logger, config) {
        ...
        this.workerId = `clinical-emr-worker-${process.pid}-${Date.now()}`;
    }
    /**
     * Start the worker
     */
...
exports.OutboxPublisherWorker = OutboxPublisherWorker = __decorate([
    (0, inversify_1.injectable)(),
    __param(0, (0, inversify_1.inject)('OutboxRepository')),
    __param(1, (0, inversify_1.inject)('EventBus')),
    __param(2, (0, inversify_1.inject)('SupabaseClient')),
    __param(3, (0, inversify_1.inject)('Logger')),
    __metadata("design:paramtypes", [Object, Object, supabase_js_1.SupabaseClient, Object, Object])
