...
class SupabaseMedicalRecordRepository {
    ...
    async save(medicalRecord) {
        try {
            ...
            if (error) {
                ...
                throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Lỗi lưu hồ sơ bệnh án: ${error.message}`, "SAVE_FAILED");
            }
            // HIPAA audit logging
            await this.auditService.logMedicalRecordAccess('SAVE', medicalRecord.recordId.value, 'SYSTEM', 'Medical record saved to database', {
                patientId: medicalRecord.patientId,
                doctorId: medicalRecord.doctorId,
                status: medicalRecord.status
            });
            ...
            if (error instanceof IMedicalRecordRepository_1.MedicalRecordRepositoryError) {
                throw error;
            }
            throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Lỗi lưu hồ sơ bệnh án: ${error instanceof Error ? error.message : 'Unknown error'}`, "REPOSITORY_ERROR");
        }
    }
    /**
    ...
    async findById(recordId) {
        try {
            ...
            if (error) {
                ...
                throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Lỗi truy vấn database: ${error.message}`, "FIND_FAILED");
            }
            if (!data)
                return null;
            // HIPAA audit logging
            await this.auditService.logMedicalRecordAccess('READ', recordId.value, 'SYSTEM', 'Medical record retrieved by ID', { recordId: recordId.value });
            ...
            throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Lỗi tìm hồ sơ bệnh án: ${error instanceof Error ? error.message : 'Unknown error'}`, "REPOSITORY_ERROR");
        }
    }
    /**
     * Find medical record by string ID
     */
    async findByStringId(recordId) {
    ...
    async findByPatientId(patientId, options) {
        try {
            ...
            if (error) {
                throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Failed to find medical records by patient: ${error.message}`, "FIND_BY_PATIENT_FAILED");
            }
            ...
            throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Repository error during findByPatientId: ${error instanceof Error ? error.message : "Unknown error"}`, "REPOSITORY_ERROR");
        }
    }
    /**
    ...
    async findByDoctorId(doctorId, options) {
        try {
            ...
            const { data, error } = await query;
            if (error) {
                throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Failed to find medical records by doctor: ${error.message}`, "FIND_BY_DOCTOR_FAILED");
            }
            return data.map((record) => this.mapDatabaseToAggregate(record));
        }
        catch (error) {
            ...
            throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Repository error during findByDoctorId: ${error instanceof Error ? error.message : "Unknown error"}`, "REPOSITORY_ERROR");
        }
    }
    /**
    ...
    async findByAppointmentId(appointmentId) {
        try {
            ...
            if (error) {
                ...
                throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Failed to find medical record by appointment: ${error.message}`, "FIND_BY_APPOINTMENT_FAILED");
            }
            ...
            throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Repository error during findByAppointmentId: ${error instanceof Error ? error.message : "Unknown error"}`, "REPOSITORY_ERROR");
        }
    }
    /**
    ...
    async search(criteria) {
        try {
            ...
            if (criteria.visitDateFrom) {
                query = query.gte("visit_date", criteria.visitDateFrom.toISOString().split("T")[0]);
            }
            if (criteria.visitDateTo) {
                query = query.lte("visit_date", criteria.visitDateTo.toISOString().split("T")[0]);
            }
            // Text search
            if (criteria.searchText) {
                query = query.or(`symptoms.ilike.%${criteria.searchText}%,diagnosis.ilike.%${criteria.searchText}%,treatment.ilike.%${criteria.searchText}%`);
            }
            // Status filters
            ...
            if (error) {
                throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Failed to search medical records: ${error.message}`, "SEARCH_FAILED");
            }
            ...
            throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Repository error during search: ${error instanceof Error ? error.message : "Unknown error"}`, "REPOSITORY_ERROR");
        }
    }
    /**
     * Count medical records by patient
     */
    async countByPatientId(patientId, status) {
        try {
            const client = await this.supabaseClient.getConnection();
            let query = client
                .from("medical_records")
            ...
            if (error) {
                throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Failed to count medical records by patient: ${error.message}`, "COUNT_BY_PATIENT_FAILED");
            }
            return count || 0;
        }
        catch (error) {
            ...
            throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Repository error during countByPatientId: ${error instanceof Error ? error.message : "Unknown error"}`, "REPOSITORY_ERROR");
        }
    }
    /**
     * Count medical records by doctor
     */
    async countByDoctorId(doctorId, status) {
        try {
            const client = await this.supabaseClient.getConnection();
            let query = client
                .from("medical_records")
            ...
            const { count, error } = await query;
            if (error) {
                throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Failed to count medical records by doctor: ${error.message}`, "COUNT_BY_DOCTOR_FAILED");
            }
            return count || 0;
        }
        catch (error) {
            ...
            throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Repository error during countByDoctorId: ${error instanceof Error ? error.message : "Unknown error"}`, "REPOSITORY_ERROR");
        }
    }
    /**
    ...
    async update(medicalRecord) {
        try {
            ...
            if (error) {
                throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Failed to update medical record: ${error.message}`, "UPDATE_FAILED");
            }
        }
        catch (error) {
            if (error instanceof IMedicalRecordRepository_1.MedicalRecordRepositoryError) {
            ...
            throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Repository error during update: ${error instanceof Error ? error.message : "Unknown error"}`, "REPOSITORY_ERROR");
        }
    }
    /**
    ...
    async delete(recordId, deletedBy) {
        try {
            ...
            const { error } = await client
                ...
                .eq("record_id", recordId.value);
            if (error) {
                throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Failed to delete medical record: ${error.message}`, "DELETE_FAILED");
            }
        }
        catch (error) {
            if (error instanceof IMedicalRecordRepository_1.MedicalRecordRepositoryError) {
            ...
            throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Repository error during delete: ${error instanceof Error ? error.message : "Unknown error"}`, "REPOSITORY_ERROR");
        }
    }
    /**
    ...
    async findByDateRange(startDate, endDate, options) {
        try {
            ...
            const { data, error } = await query;
            if (error) {
                throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Failed to find medical records by date range: ${error.message}`, "FIND_BY_DATE_RANGE_FAILED");
            }
            return data.map((record) => this.mapDatabaseToAggregate(record));
        }
        catch (error) {
            ...
            throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Repository error during findByDateRange: ${error instanceof Error ? error.message : "Unknown error"}`, "REPOSITORY_ERROR");
        }
    }
    /**
    ...
    async getPatientStatistics(patientId) {
        try {
            ...
            const { data, error } = await client
                ...
                .eq("patient_id", patientId);
            if (error) {
                throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Failed to get patient statistics: ${error.message}`, "GET_PATIENT_STATISTICS_FAILED");
            }
            const records = data.map((record) => this.mapDatabaseToAggregate(record));
            return {
                ...
                recordsWithCompleteVitalSigns: records.filter((r) => r.hasCompleteVitalSigns()).length,
                uniqueDoctors: new Set(records.map((r) => r.doctorId)).size,
                firstVisit: records.length > 0
                    ? records.reduce((earliest, record) => record.visitDate < earliest ? record.visitDate : earliest, records[0].visitDate)
                    : null,
                lastVisit: records.length > 0
                    ? records.reduce((latest, record) => record.visitDate > latest ? record.visitDate : latest, records[0].visitDate)
                    : null,
            };
        }
        catch (error) {
            ...
            throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Repository error during getPatientStatistics: ${error instanceof Error ? error.message : "Unknown error"}`, "REPOSITORY_ERROR");
        }
    }
    /**
    ...
    async getDoctorStatistics(doctorId) {
        try {
            ...
            const { data, error } = await client
                ...
                .eq("doctor_id", doctorId);
            if (error) {
                throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Failed to get doctor statistics: ${error.message}`, "GET_DOCTOR_STATISTICS_FAILED");
            }
            const records = data.map((record) => this.mapDatabaseToAggregate(record));
            return {
                totalRecords: records.length,
                ...
                recordsThisMonth: records.filter((r) => {
                    const now = new Date();
                    return (r.visitDate.getMonth() === now.getMonth() &&
            ...
            throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Repository error during getDoctorStatistics: ${error instanceof Error ? error.message : "Unknown error"}`, "REPOSITORY_ERROR");
        }
    }
    /**
    ...
    async advancedSearch(criteria, options) {
        ...
        `, { count: "exact" });
            ...
            if (criteria.dateFrom) {
                query = query.gte("visit_date", criteria.dateFrom.toISOString().split("T")[0]);
            }
            if (criteria.dateTo) {
                query = query.lte("visit_date", criteria.dateTo.toISOString().split("T")[0]);
            }
            // Status filters
            if (!criteria.includeArchived) {
                query = query.neq("status", "archived");
            ...
            if (criteria.searchText && options?.useFullTextSearch) {
                ...
                query = query.or(`symptoms.ilike.${searchPattern},examination_notes.ilike.${searchPattern},notes.ilike.${searchPattern}`);
            }
            ...
            const { data, error, count } = await query;
            if (error) {
                throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Advanced search failed: ${error.message}`, "ADVANCED_SEARCH_FAILED");
            }
            const records = data.map((record) => this.mapDatabaseToAggregate(record));
            const totalCount = count || 0;
            const totalPages = Math.ceil(totalCount / pageSize);
            ...
            if (criteria.hasCriticalDiagnoses) {
                filteredRecords = filteredRecords.filter((r) => r.getCriticalDiagnoses().length > 0);
            }
            if (criteria.hasActiveMedications) {
                filteredRecords = filteredRecords.filter((r) => r.getActiveMedications().length > 0);
            }
            if (criteria.hasVitalSigns) {
                filteredRecords = filteredRecords.filter((r) => r.hasVitalSigns());
            }
            if (criteria.fhirCompliant !== undefined) {
                filteredRecords = filteredRecords.filter((r) => r.isFHIRCompliant() === criteria.fhirCompliant);
            }
            return {
            ...
            throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Repository error during advanced search: ${error instanceof Error ? error.message : "Unknown error"}`, "REPOSITORY_ERROR");
        }
    }
    /**
     * Get medical records with FHIR export data
     */
    async findWithFHIRData(recordIds) {
        try {
            const records = await Promise.all(recordIds.map((id) => this.findByStringId(id)));
            return records
            ...
            throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Failed to find records with FHIR data: ${error instanceof Error ? error.message : "Unknown error"}`, "FIND_WITH_FHIR_FAILED");
        }
    }
    /**
    ...
    async bulkUpdate(updates) {
        try {
            ...
            if (error) {
                throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Bulk update failed: ${error.message}`, "BULK_UPDATE_FAILED");
            }
        }
        catch (error) {
            if (error instanceof IMedicalRecordRepository_1.MedicalRecordRepositoryError) {
            ...
            throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Repository error during bulk update: ${error instanceof Error ? error.message : "Unknown error"}`, "REPOSITORY_ERROR");
        }
    }
    /**
     * Get performance analytics
     */
    async getPerformanceAnalytics(dateFrom, dateTo) {
        try {
            const client = await this.supabaseClient.getConnection();
            ...
            const { data: records, error } = await client
                ...
                .neq("status", "deleted");
            if (error) {
                throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Failed to get performance analytics: ${error.message}`, "ANALYTICS_FAILED");
            }
            ...
            const fhirCompliantCount = aggregates.filter((r) => r.isFHIRCompliant()).length;
            const fhirComplianceRate = totalRecords > 0 ? fhirCompliantCount / totalRecords : 0;
            ...
            const completenessScores = aggregates.map((record) => {
                ...
                if (record.medications.length > 0)
                    score += 0.2;
                if (record.hasVitalSigns())
                    score += 0.1;
                return score;
            });
            const avgRecordCompleteness = completenessScores.length > 0
            ...
            throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Repository error during analytics: ${error instanceof Error ? error.message : "Unknown error"}`, "REPOSITORY_ERROR");
        }
    }
    /**
     * Map aggregate to database format with enhanced data
     */
    mapAggregateToDatabase(aggregate) {
        return {
     ...
     */
    generateSearchVector(aggregate) {
        const searchableText = [];
        if (aggregate.symptoms)
            searchableText.push(aggregate.symptoms);
        if (aggregate.examinationNotes)
            searchableText.push(aggregate.examinationNotes);
        if (aggregate.notes)
            searchableText.push(aggregate.notes);
        ...
        aggregate.medications.forEach((m) => {
            ...
            if (m.genericName)
                searchableText.push(m.genericName);
        });
     ...
     */
    mapDatabaseToAggregate(dbRecord) {
        const recordId = RecordId_1.RecordId.create(dbRecord.record_id);
        let vitalSigns;
        if (dbRecord.vital_signs && Object.keys(dbRecord.vital_signs).length > 0) {
            vitalSigns = BasicVitalSigns_1.BasicVitalSigns.create(dbRecord.vital_signs);
        }
        ...
        if (dbRecord.diagnoses_json) {
            try {
                ...
                diagnoses = diagnosesData.map((d) => Diagnosis_1.Diagnosis.create(d.code, d.display, d.category, d.severity, d.status, d.recorded_by || dbRecord.created_by));
            }
            catch (e) {
                diagnoses = [];
            }
        ...
        if (dbRecord.medications_json) {
            try {
                ...
                medications = medicationsData.map((m) => Medication_1.Medication.create(m.code, m.name, m.strength, m.dosage_form, m.route, m.dosage, m.frequency, m.frequency_unit, m.instructions, m.prescribed_by || dbRecord.created_by));
            }
            catch (e) {
                medications = [];
            }
        }
        return clinical_aggregate_1.MedicalRecordAggregate.reconstitute({
            recordId,
     ...
     */
    async getNextSequenceNumber(yearMonth) {
        try {
            const client = await this.supabaseClient.getConnection();
            ...
            const { data, error } = await client
                ...
                .limit(1);
            if (error) {
                throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Lỗi lấy sequence number: ${error.message}`, "SEQUENCE_ERROR");
            }
            ...
            throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Lỗi tạo sequence number: ${error instanceof Error ? error.message : 'Unknown error'}`, "SEQUENCE_ERROR");
        }
    }
    /**
     * Update existing medical record
     */
    async updateRecord(medicalRecord) {
        try {
            ...
            const { error } = await client
                ...
                .eq('record_id', medicalRecord.recordId.value);
            if (error) {
                throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Lỗi cập nhật hồ sơ bệnh án: ${error.message}`, "UPDATE_FAILED");
            }
            // HIPAA audit logging
            await this.auditService.logMedicalRecordAccess('UPDATE', medicalRecord.recordId.value, 'SYSTEM', 'Medical record updated', {
                patientId: medicalRecord.patientId,
                doctorId: medicalRecord.doctorId
            });
        }
            ...
            throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Lỗi cập nhật hồ sơ bệnh án: ${error instanceof Error ? error.message : 'Unknown error'}`, "UPDATE_ERROR");
        }
    }
    /**
     * Convert domain aggregate to persistence format
     */
    toPersistence(medicalRecord) {
        return {
            id: medicalRecord.id,
     ...
     */
    async findRecent(limit = 20, status) {
        try {
            const client = await this.supabaseClient.getConnection();
            let query = client
                .schema(this.schema)
            ...
            const { data, error } = await query;
            if (error) {
                throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Failed to find recent records: ${error.message}`, 'FIND_RECENT_FAILED');
            }
            return data.map(record => this.mapDatabaseToAggregate(record));
        }
        catch (error) {
            throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Repository error during findRecent: ${error instanceof Error ? error.message : 'Unknown'}`, 'REPOSITORY_ERROR');
        }
    }
    /**
    ...
    async bulkSave(medicalRecords) {
        try {
            ...
            if (error) {
                throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Bulk save failed: ${error.message}`, 'BULK_SAVE_FAILED');
            }
        }
        catch (error) {
            throw new IMedicalRecordRepository_1.MedicalRecordRepositoryError(`Repository error during bulkSave: ${error instanceof Error ? error.message : 'Unknown'}`, 'REPOSITORY_ERROR');
        }
    }
}
exports.SupabaseMedicalRecordRepository = SupabaseMedicalRecordRepository;
//# sourceMappingURL=SupabaseMedicalRecordRepository.js.map