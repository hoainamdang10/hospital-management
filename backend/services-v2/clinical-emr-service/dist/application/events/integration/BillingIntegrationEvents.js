 ...
 */
class MedicalRecordCompletedEvent extends IntegrationEvent_1.IntegrationEvent {
    constructor(recordId, patientId, doctorId, appointmentId, visitDate, diagnoses, medications, procedures, billingInfo, completedBy, completedAt = new Date()) {
        super('clinical-emr.medical-record.completed', recordId, {
            recordId,
            patientId,
            doctorId,
            appointmentId,
 ...
 */
class MedicalRecordUpdatedForBillingEvent extends IntegrationEvent_1.IntegrationEvent {
    constructor(recordId, patientId, changes, billingImpact, updatedBy, updatedAt = new Date()) {
        super('clinical-emr.medical-record.updated-for-billing', recordId, {
            recordId,
            patientId,
            changes,
            billingImpact,
 ...
 */
class InsuranceVerificationRequiredEvent extends IntegrationEvent_1.IntegrationEvent {
 ...
 */
class PaymentRequiredEvent extends IntegrationEvent_1.IntegrationEvent {
