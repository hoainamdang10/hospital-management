...
exports.UpdateMedicalRecordValidationRules = void 0;
exports.validateUpdateMedicalRecordRequest = validateUpdateMedicalRecordRequest;
exports.extractUpdateFields = extractUpdateFields;
exports.hasVitalSignsUpdate = hasVitalSignsUpdate;
/**
 * Validation rules for UpdateMedicalRecordRequest
 */
exports.UpdateMedicalRecordValidationRules = {
    recordId: {
        required: true,
        pattern: /^MED-\d{6}-\d{3}$/,
 ...
 */
function validateUpdateMedicalRecordRequest(request) {
    const errors = [];
    ...
    else if (!exports.UpdateMedicalRecordValidationRules.recordId.pattern.test(request.recordId)) {
        errors.push({
            field: 'recordId',
            message: exports.UpdateMedicalRecordValidationRules.recordId.message,
            code: 'INVALID_FORMAT',
            value: request.recordId
        });
    }
    ...
    else if (!exports.UpdateMedicalRecordValidationRules.updatedBy.pattern.test(request.updatedBy)) {
        errors.push({
            field: 'updatedBy',
            message: exports.UpdateMedicalRecordValidationRules.updatedBy.message,
            code: 'INVALID_FORMAT',
            value: request.updatedBy
        });
    }
    ...
    textFields.forEach(field => {
        ...
        if (value !== undefined && value !== null) {
            const rule = exports.UpdateMedicalRecordValidationRules[field];
    ...
    if (request.vitalSigns) {
        ...
        if (vitalSigns.bloodPressure !== undefined) {
            if (!exports.UpdateMedicalRecordValidationRules.vitalSigns.properties.bloodPressure.pattern.test(vitalSigns.bloodPressure)) {
                errors.push({
 ...
 */
function extractUpdateFields(request) {
    const updates = {};
    if (request.symptoms !== undefined)
        updates.symptoms = request.symptoms;
    if (request.examinationNotes !== undefined)
        updates.examinationNotes = request.examinationNotes;
    if (request.diagnosis !== undefined)
        updates.diagnosis = request.diagnosis;
    if (request.treatment !== undefined)
        updates.treatment = request.treatment;
    if (request.medications !== undefined)
        updates.medications = request.medications;
 ...
 */
function hasVitalSignsUpdate(request) {
    return !!(request.vitalSigns && Object.keys(request.vitalSigns).length > 0);
}
//# sourceMappingURL=UpdateMedicalRecordRequest.js.map