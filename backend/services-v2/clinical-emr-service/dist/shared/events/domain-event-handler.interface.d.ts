...
export interface IEventHandlerRegistry {
     ...
     */
    register<T extends DomainEvent>(eventType: string, handler: IDomainEventHandler<T>, priority?: number): void;
    /**
...
//# sourceMappingURL=domain-event-handler.interface.d.ts.map