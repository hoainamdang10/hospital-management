...
class ImagingStudyController {
    constructor(createUseCase, listUseCase, deleteUseCase, auditLogUseCase, recordAccessUseCase, eventDispatcher) {
        ...
        this.create = async (req, res, next) => {
            try {
                ...
                if (patientId) {
                    await this.eventDispatcher.imagingStudyCreated(dto, patientId, req.user?.id);
                }
