...
import { CosignClinicalNoteRequest, CosignClinicalNoteResponse, validateCosignClinicalNoteRequest } from '../dto/ClinicalNoteRequest';
import { IDomainEventPublisher } from '@shared/domain/events/IDomainEventPublisher';

export class CosignClinicalNoteUseCase extends BaseHealthcareUseCase<CosignClinicalNoteRequest, CosignClinicalNoteResponse> {
  constructor(
  ...
  override async execute(request: CosignClinicalNoteRequest): Promise<CosignClinicalNoteResponse> {
    // Validate
  ...
  protected async executeInternal(request: CosignClinicalNoteRequest): Promise<CosignClinicalNoteResponse> {
    try {
      // Find clinical note
      ...
      if (error instanceof Error && (
        error.message.includes('không yêu cầu ký tên') ||
  ...
  override async validate(request: CosignClinicalNoteRequest): Promise<ValidationResult> {
    const errors = validateCosignClinicalNoteRequest(request);
  ...
  async authorize(request: CosignClinicalNoteRequest, userId: string): Promise<boolean> {
