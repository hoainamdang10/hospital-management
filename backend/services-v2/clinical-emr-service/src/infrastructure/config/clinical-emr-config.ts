...
@injectable()
export class ClinicalEMRConfig {
  // =====================================================
  ...
  public readonly databaseSchema: string;
  ...
  public readonly enableAuditLogging: boolean;
  public readonly auditLogRetentionDays: number;

  // =====================================================
  // PERFORMANCE CONFIGURATION
  // =====================================================
  
  public readonly connectionPoolMin: number;
  public readonly connectionPoolMax: number;
  ...
  public readonly maxRecordsPerPatient: number;
  public readonly maxRecordsPerDoctor: number;
  public readonly recordRetentionYears: number;
  public readonly enableVitalSignsValidation: boolean;
  public readonly enableDiagnosisValidation: boolean;
  ...
  public readonly patientServiceUrl: string;
  public readonly doctorServiceUrl: string;
  public readonly appointmentServiceUrl: string;
  public readonly notificationServiceUrl: string;
  ...
  public readonly enablePerformanceMonitoring: boolean;

  // =====================================================
  // FEATURE FLAGS
  // =====================================================
  
  public readonly enableAdvancedSearch: boolean;
  public readonly enableRealTimeUpdates: boolean;
  public readonly enableFileAttachments: boolean;
  public readonly enableAuditTrail: boolean;
  public readonly enableDataEncryption: boolean;
