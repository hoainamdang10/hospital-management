...
export interface IBillingRepository {
  ...
  getStatistics(criteria?: {
    ...
    paymentMethodBreakdown: Record<PaymentMethod, { count: number; amount: Money }>;
    insuranceBreakdown: Record<InsuranceType, { count: number; amount: Money }>;
    statusBreakdown: Record<InvoiceStatus, { count: number; amount: Money }>;
    monthlyTrends: Array<{
      month: string;
      invoiceCount: number;
      totalAmount: Money;
