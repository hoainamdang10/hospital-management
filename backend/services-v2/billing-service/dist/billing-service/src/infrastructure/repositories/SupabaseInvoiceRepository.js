...
class SupabaseInvoiceRepository {
    ...
    async save(invoice) {
        const record = InvoiceMapper_1.InvoiceMapper.toPersistence(invoice);
    ...
    async findById(id) {
        ...
        return data ? InvoiceMapper_1.InvoiceMapper.toDomain(data) : null;
    }
    async findByPatientId(patientId) {
        ...
        return data ? data.map(InvoiceMapper_1.InvoiceMapper.toDomain) : [];
    }
