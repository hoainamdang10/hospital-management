...
export declare class PaymentPlanCompletedEvent extends DomainEvent<PaymentPlanCompletedEventPayload> {
    constructor(payload: PaymentPlanCompletedEventPayload);
}
//# sourceMappingURL=PaymentPlanCompletedEvent.d.ts.map