 ...
 */
export declare const insuranceRateLimit: any;
/**
 ...
 */
export declare const roleBasedRateLimit: (req: Request, res: Response, next: NextFunction) => any;
/**
 ...
 */
export declare const rateLimitMiddleware: (req: Request, res: Response, next: NextFunction) => any;
/**
