...
exports.BHTNAPIService = void 0;
/**
 * BHTNAPIService
 * Handles integration with Vietnamese BHTN system
 */
class BHTNAPIService {
    constructor(config) {
        this.config = config;
    }
    /**
     ...
     * Get accident report
     */
    async getAccidentReport(accidentId) {
        try {
            await this.ensureAuthenticated();
     ...
     */
    async callBHTNAPI(endpoint, options) {
     ...
     */
    calculateCoverage(accidentInfo) {
        return {
     ...
     * Generate warnings
     */
    generateWarnings(accidentInfo, approvalStatus) {
        const warnings = [];
...
exports.BHTNAPIService = BHTNAPIService;
//# sourceMappingURL=BHTNAPIService.js.map