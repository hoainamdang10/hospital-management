...
const NoopSchedulerAdapter_1 = require("../adapters/NoopSchedulerAdapter");
...
class DIContainer {
    ...
    initializeServices() {
        ...
        this.reminderService = new ReminderService_1.ReminderService(this.schedulerAdapter);
    ...
    initializeUseCases() {
        ...
        this.cancelAppointmentUseCase = new CancelAppointment_use_case_1.CancelAppointmentUseCase(this.appointmentRepository, this.authorizationService, this.reminderService, this.appEventPublisher);
        ...
        this.createAppointmentReminderUseCase =
            new CreateAppointmentReminderUseCase_1.CreateAppointmentReminderUseCase(this.reminderRepository, this.appointmentRepository);
        ...
        this.updateAppointmentReminderUseCase =
            new UpdateAppointmentReminderUseCase_1.UpdateAppointmentReminderUseCase(this.reminderRepository);
    ...
    initializeEventHandlers() {
        ...
        */
        ...
        this.paymentCompletedHandler = new PaymentCompletedHandler_1.PaymentCompletedHandler(this.appointmentRepository, this.appointmentReadModelRepository);
    ...
    initializeControllers() {
        ...
        this.availabilityController = new AvailabilityController_1.AvailabilityController(this.findAvailableTimeSlotsUseCase, this.providerScheduleRepository, this.httpProviderService);
        // ===== ARCHIVED FOR POST-MVP: Waitlist Controller =====
