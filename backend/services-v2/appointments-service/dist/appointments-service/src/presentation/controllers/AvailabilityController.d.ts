...
export declare class AvailabilityController {
    ...
    constructor(findAvailableTimeSlotsUseCase: FindAvailableTimeSlotsUseCase, providerScheduleRepository: IProviderScheduleRepository, httpProviderService: HttpProviderService);
    /**
     * GET /api/appointments/providers/:providerId/available-slots
     *
     * Query params:
