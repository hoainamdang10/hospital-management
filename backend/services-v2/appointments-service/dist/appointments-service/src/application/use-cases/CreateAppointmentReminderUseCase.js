...
exports.CreateAppointmentReminderUseCase = void 0;
const AppointmentReminder_entity_1 = require("../../domain/entities/AppointmentReminder.entity");
class CreateAppointmentReminderUseCase {
    ...
    async execute(command) {
        try {
            ...
            const appointment = await this.appointmentRepository.findByAppointmentId(command.appointmentId);
            if (!appointment) {
                return {
                    success: false,
            ...
            const appointmentTime = appointment.props.timeSlot.startTime;
            ...
            const appointmentProps = appointment.props;
            const recipientId = command.recipientType === AppointmentReminder_entity_1.RecipientType.PATIENT
                ? appointmentProps.patientId
                : command.recipientType === AppointmentReminder_entity_1.RecipientType.DOCTOR
                    ? appointmentProps.doctorId
                    : appointmentProps.patientId; // Default to patient for 'both'
            // 6. Create reminder entity
            const reminder = AppointmentReminder_entity_1.AppointmentReminder.create({
                ...
                priority: command.priority || AppointmentReminder_entity_1.ReminderPriority.NORMAL,
...
exports.CreateAppointmentReminderUseCase = CreateAppointmentReminderUseCase;
//# sourceMappingURL=CreateAppointmentReminderUseCase.js.map