 ...
 */
export declare class AppointmentRescheduledEvent extends DomainEvent<AppointmentRescheduledEventData> {
    constructor(appointmentId: string, patientId: string, providerId: string, originalStartTime: Date, originalEndTime: Date, newStartTime: Date, newEndTime: Date, rescheduleReason: string, rescheduledBy: string);
    /**
