...
export function createEventSubscriptions(
  ...
  if (!patientEventConsumer || !providerEventConsumer) {
    ...
    patientEventConsumer = new PatientEventConsumer(patientReadModelRepo, inboxRepo);
    providerEventConsumer = new ProviderEventConsumer(providerReadModelRepo, inboxRepo);
  }
