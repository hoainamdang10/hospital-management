...
export interface PerformanceMetrics {
  check_in_speed: number; // average time in seconds
  queue_management_efficiency: number; // percentage
  patient_satisfaction_score: number; // 1-10 scale
...
export class CheckInError extends ReceptionistError {
  constructor(message: string, code: string = 'CHECK_IN_ERROR') {
    super(message, code, 400);
    this.name = 'CheckInError';
  }
}

export class QueueError extends ReceptionistError {
