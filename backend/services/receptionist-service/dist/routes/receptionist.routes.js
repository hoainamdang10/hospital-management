...
router.get('/:receptionistId', auth_middleware_1.authMiddleware, receptionistController.getProfile);
router.put('/:receptionistId/schedule', auth_middleware_1.authMiddleware, receptionistController.updateShiftSchedule);
