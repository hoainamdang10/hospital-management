...
exports.openAPISpec = exports.swaggerSpec = void 0;
exports.setupSwagger = setupSwagger;
exports.addOpenAPIDocumentation = addOpenAPIDocumentation;
exports.validateOpenAPISpec = validateOpenAPISpec;
const swagger_jsdoc_1 = __importDefault(require("swagger-jsdoc"));
const swagger_ui_express_1 = __importDefault(require("swagger-ui-express"));
const openapi_config_1 = require("@hospital/shared/dist/config/openapi.config");
const doctor_schemas_1 = require("@hospital/shared/dist/schemas/doctor.schemas");
/**
 * Swagger/OpenAPI 3.0 configuration for API Gateway
 */
const swaggerOptions = {
    definition: {
        ...openapi_config_1.baseOpenAPIConfig,
        info: {
            ...openapi_config_1.baseOpenAPIConfig.info,
...
**📖 Tài liệu:** [API Documentation](/docs)
      `
        ...
        components: {
            ...openapi_config_1.baseOpenAPIConfig.components,
            schemas: {
                ...openapi_config_1.baseOpenAPIConfig.components?.schemas,
                ...doctor_schemas_1.doctorSchemas
            }
        }
    },
    apis: [
...
exports.openAPISpec = exports.swaggerSpec;
// Add doctor paths to the spec
if (exports.swaggerSpec.paths) {
    Object.assign(exports.swaggerSpec.paths, doctor_schemas_1.doctorPaths);
}
else {
    exports.swaggerSpec.paths = doctor_schemas_1.doctorPaths;
}
/**
...
function setupSwagger(app) {
    ...
    app.get('/docs', swagger_ui_express_1.default.setup(exports.swaggerSpec, swaggerUiOptions));
 ...
 */
function addOpenAPIDocumentation() {
    return {
...
function validateOpenAPISpec() {
    try {
        // Basic validation
        if (!exports.swaggerSpec.openapi) {
            throw new Error('Missing OpenAPI version');
        }
        if (!exports.swaggerSpec.info || !exports.swaggerSpec.info.title || !exports.swaggerSpec.info.version) {
            throw new Error('Missing required info fields');
        }
        if (!exports.swaggerSpec.paths || Object.keys(exports.swaggerSpec.paths).length === 0) {
            console.warn('⚠️ No API paths defined in OpenAPI spec');
        }
        console.log('✅ OpenAPI specification is valid');
        console.log(`📋 API Title: ${exports.swaggerSpec.info.title}`);
        console.log(`🔢 API Version: ${exports.swaggerSpec.info.version}`);
        console.log(`📊 Total paths: ${Object.keys(exports.swaggerSpec.paths || {}).length}`);
        console.log(`📦 Total schemas: ${Object.keys(exports.swaggerSpec.components?.schemas || {}).length}`);
        return true;
    }
    catch (error) {
