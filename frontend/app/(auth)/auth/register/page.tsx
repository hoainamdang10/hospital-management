      ...
      <div className="p-8 sm:p-10">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-semibold text-gray-700 uppercase tracking-wider ml-1">Họ và tên</label>
            ...
            {errors.fullName && (
              <p className="ml-1 text-xs font-medium text-red-500">{errors.fullName.message}</p>
            )}
          </div>
          ...
          {/* Confirm Password */}
          <div className="space-y-1.5">
            <label className="text-xs font-semibold text-gray-700 uppercase tracking-wider ml-1">Xác nhận mật khẩu</label>
            <div className="relative group">
              <input
            ...
            {errors.confirmPassword && (
              <p className="ml-1 text-xs font-medium text-red-500">{errors.confirmPassword.message}</p>
            )}
          </div>
          ...
          <div className="flex items-start gap-3 pt-1">
            ...
            <label htmlFor="acceptTerms" className="text-sm text-gray-600 cursor-pointer">
              Tôi đồng ý với{' '}
              <Link href="/terms" className="font-medium text-blue-600 hover:text-blue-700 hover:underline transition-all">
                Điều khoản sử dụng
              </Link>{' '}
              và{' '}
              <Link href="/privacy" className="font-medium text-blue-600 hover:text-blue-700 hover:underline transition-all">
                Chính sách bảo mật
              </Link>
            </label>
          </div>
          {errors.acceptTerms && (
            <p className="ml-1 text-xs font-medium text-red-500">{errors.acceptTerms.message}</p>
          )}
